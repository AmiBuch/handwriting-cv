...
# iterate through each sentence in the file 
    ...
    # tokenize the sentence into words 
        ...
        return flask.render_template('main.html', original_input = {'Words that are important in the answer (1 mark)':oneM, 'Words that are important in the answer (2 mark)':twoM}, result = str(count) + "from" + str(total),)
